...
public class Medico extends Usuario {
    ...
    /**
     * Constructor con todos los atributos, incluyendo los de la clase padre Usuario.
     * 
    ...
    public Medico(int IDUsuario, String contrasenaUsuario, String nombresMedico, String apellidoPaternoMedico, 
                  String apellidoMaternoMedico, String cedulaProfesional, String especialidad, String estado) {
     ...
     * @param especialidad Especialidad del médico
     * @param estado Estado del médico
     * @param nombreUsuario Nombre de usuario para acceso
     * @param contrasenaUsuario Contraseña del usuario
     */
    public Medico(String nombresMedico, String apellidoPaternoMedico, String apellidoMaternoMedico, 
                  String cedulaProfesional, String especialidad, String estado, String nombreUsuario, String contrasenaUsuario) {
     ...
     * 
     * @return La información del médico en formato de cadena.
     */
    @Override
